        ...
        {isSuccess ? (
          <Card className="w-full max-w-md">
            <CardHeader className="space-y-1">
              ...
              <CardDescription>Reset instructions sent</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col items-center justify-center py-6 space-y-6">
              ...
              <div className="text-center space-y-2">
                <p className="font-medium">We've sent reset instructions to:</p>
            ...
            <CardFooter>
              <Button asChild className="w-full">
                <Link
                  href={`/login${safeRedirectUrl !== "/dashboard" ? `?redirectTo=${encodeURIComponent(safeRedirectUrl)}` : ""}`}
                >
                  Back to Login
                </Link>
              </Button>
